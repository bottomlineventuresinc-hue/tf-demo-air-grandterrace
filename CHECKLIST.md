# Site customization checklist · Air Electric (hs-046-air)
Wave 10 · Copperline · claim/$297 + hosting/$99 bar required. Rebuilt 2026-09-25 (CEO change request).

Before preview send:
- [x] Business name everywhere (title, wordmark, footer, schema)
- [x] City / service area
- [x] Phone click-to-call is the main CTA (tel-only; no public email)
- [x] Address per packet (FARM-PACKETS-WAVE10.md)
...
Owner first name in human spots: Gary
NAP/phone per packet: 22645 Franklin St, Grand Terrace CA 92313 · 909-559-0742
lang: en-US · geo: CA
...
Lead-specific notes kept: Contact Gary per packet (license is sole ownership under Gary). No local domain.
Prior folder backed up at ops/cr-2026-09-25/backup/hs-046-air/.
...
the home city (Grand Terrace) plus areas the packet itself lists. Packet line: "Coverage: Grand Terrace / IE".
