/* Template Factory - Air Electric live demo journey.
...
(function () {
  ...
  var LIVE_URL = 'https://bottomlineventuresinc-hue.github.io/tf-demo-air-grandterrace/';
  var LS_CHANGES = 'tf_air_change_log_v1';
  var LS_PURCHASED = 'tf_air_purchased_v1';
  ...
  function setBarMode(mode) {
    ...
    if (!barSub) return;
    if (mode === 'updated') {
      barSub.textContent = 'Draft for Gary at Air Electric. Claim it, preview the rest of the journey, or request a change.';
    } else {
      barSub.textContent = 'Draft for Gary at Air Electric. Claim it, preview the rest of the journey, or request a change.';
    }
  }
  ...
  if (changeForm) {
    changeForm.addEventListener('submit', function (e) {
      ...
      runSpinner(
        ...
        'Updating the draft for Air Electric. Hang tight.',
        delay,
        function () {
